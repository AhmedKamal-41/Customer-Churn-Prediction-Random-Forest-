...
export default function SessionsPage() {
  ...
  const handleDelete = (e, id) => {
    ...
    deleteSession(id)
    console.log('Sessions delete:', id)
                    ...
                    <td className="py-2 px-2">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                          variant="ghost"
                          type="button"
                          onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleDelete(e, session.id); }}
                          className="text-xs py-1.5 text-red-400 hover:text-red-300"
                        >
                          Delete
                        </Button>
                      </div>
